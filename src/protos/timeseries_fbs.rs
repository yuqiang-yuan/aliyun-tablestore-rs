...
impl<'a> BytesValue<'a> {
  ...
  pub fn value(&self) -> Option<flatbuffers::Vector<'a, i8>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i8>>>(BytesValue::VT_VALUE, None)}
  }
}
...
impl<'a> FieldValues<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.binary_values { builder.add_binary_values(x); }
    if let Some(x) = args.string_values { builder.add_string_values(x); }
    if let Some(x) = args.double_values { builder.add_double_values(x); }
    if let Some(x) = args.bool_values { builder.add_bool_values(x); }
    if let Some(x) = args.long_values { builder.add_long_values(x); }
    builder.finish()
  }
  ...
  pub fn long_values(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(FieldValues::VT_LONG_VALUES, None)}
  }
  #[inline]
  pub fn bool_values(&self) -> Option<flatbuffers::Vector<'a, bool>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, bool>>>(FieldValues::VT_BOOL_VALUES, None)}
  }
  #[inline]
  pub fn double_values(&self) -> Option<flatbuffers::Vector<'a, f64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(FieldValues::VT_DOUBLE_VALUES, None)}
  }
  #[inline]
  pub fn string_values(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FieldValues::VT_STRING_VALUES, None)}
  }
  #[inline]
  pub fn binary_values(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BytesValue<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BytesValue>>>>(FieldValues::VT_BINARY_VALUES, None)}
  }
}
...
impl flatbuffers::Verifiable for FieldValues<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("string_values", Self::VT_STRING_VALUES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BytesValue>>>>("binary_values", Self::VT_BINARY_VALUES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FieldValuesBuilder<'a, 'b, A> {
  ...
  pub fn add_long_values(&mut self, long_values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldValues::VT_LONG_VALUES, long_values);
  }
  #[inline]
  pub fn add_bool_values(&mut self, bool_values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , bool>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldValues::VT_BOOL_VALUES, bool_values);
  }
  #[inline]
  pub fn add_double_values(&mut self, double_values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , f64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldValues::VT_DOUBLE_VALUES, double_values);
  }
  #[inline]
  pub fn add_string_values(&mut self, string_values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldValues::VT_STRING_VALUES, string_values);
  }
  #[inline]
  pub fn add_binary_values(&mut self, binary_values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<BytesValue<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FieldValues::VT_BINARY_VALUES, binary_values);
  }
  #[inline]
...
impl<'a> FlatBufferRowInGroup<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.tag_list { builder.add_tag_list(x); }
    builder.add_meta_cache_update_time(args.meta_cache_update_time);
    if let Some(x) = args.field_values { builder.add_field_values(x); }
  ...
  pub fn field_values(&self) -> Option<FieldValues<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<FieldValues>>(FlatBufferRowInGroup::VT_FIELD_VALUES, None)}
  }
  #[inline]
  ...
  pub fn tag_list(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Tag<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Tag>>>>(FlatBufferRowInGroup::VT_TAG_LIST, None)}
  }
}
...
impl flatbuffers::Verifiable for FlatBufferRowInGroup<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Tag>>>>("tag_list", Self::VT_TAG_LIST, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FlatBufferRowInGroupBuilder<'a, 'b, A> {
  ...
  pub fn add_data_source(&mut self, data_source: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRowInGroup::VT_DATA_SOURCE, data_source);
  }
  #[inline]
  ...
  pub fn add_field_values(&mut self, field_values: flatbuffers::WIPOffset<FieldValues<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<FieldValues>>(FlatBufferRowInGroup::VT_FIELD_VALUES, field_values);
  }
  #[inline]
  pub fn add_meta_cache_update_time(&mut self, meta_cache_update_time: u32) {
    self.fbb_.push_slot::<u32>(FlatBufferRowInGroup::VT_META_CACHE_UPDATE_TIME, meta_cache_update_time, 0);
  }
  #[inline]
  pub fn add_tag_list(&mut self, tag_list: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Tag<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRowInGroup::VT_TAG_LIST, tag_list);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FlatBufferRowInGroupBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    FlatBufferRowInGroupBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a> FlatBufferRowGroup<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.measurement_name { builder.add_measurement_name(x); }
    builder.finish()
  }
  ...
  pub fn measurement_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlatBufferRowGroup::VT_MEASUREMENT_NAME, None)}
  }
  #[inline]
  pub fn field_names(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlatBufferRowGroup::VT_FIELD_NAMES, None)}
  }
  #[inline]
  pub fn field_types(&self) -> Option<flatbuffers::Vector<'a, DataType>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, DataType>>>(FlatBufferRowGroup::VT_FIELD_TYPES, None)}
  }
  #[inline]
  pub fn rows(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FlatBufferRowInGroup<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FlatBufferRowInGroup>>>>(FlatBufferRowGroup::VT_ROWS, None)}
  }
}
...
impl flatbuffers::Verifiable for FlatBufferRowGroup<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("field_names", Self::VT_FIELD_NAMES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, DataType>>>("field_types", Self::VT_FIELD_TYPES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FlatBufferRowInGroup>>>>("rows", Self::VT_ROWS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FlatBufferRowGroupBuilder<'a, 'b, A> {
  ...
  pub fn add_measurement_name(&mut self, measurement_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRowGroup::VT_MEASUREMENT_NAME, measurement_name);
  }
  #[inline]
  pub fn add_field_names(&mut self, field_names: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRowGroup::VT_FIELD_NAMES, field_names);
  }
  #[inline]
  pub fn add_field_types(&mut self, field_types: flatbuffers::WIPOffset<flatbuffers::Vector<'b , DataType>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRowGroup::VT_FIELD_TYPES, field_types);
  }
  #[inline]
...
impl<'a> FlatBufferRows<'a> {
  ...
  pub fn row_groups(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FlatBufferRowGroup<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FlatBufferRowGroup>>>>(FlatBufferRows::VT_ROW_GROUPS, None)}
  }
}
...
impl flatbuffers::Verifiable for FlatBufferRows<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FlatBufferRowGroup>>>>("row_groups", Self::VT_ROW_GROUPS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FlatBufferRowsBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_row_groups(&mut self, row_groups: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<FlatBufferRowGroup<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlatBufferRows::VT_ROW_GROUPS, row_groups);
  }
  #[inline]
...
#[inline]
pub fn finish_size_prefixed_flat_buffer_rows_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<FlatBufferRows<'a>>) {
